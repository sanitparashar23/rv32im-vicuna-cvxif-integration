...
`ifndef VERILATOR
            ...
            // localparam int unsigned PIPE_VPORT_W[2] = '{VPORT_RD_W[PIPE_VPORT_IDX[i]], VPORT_RD_W[PIPE_VPORT_IDX[i]+1]};
            // localparam int unsigned PIPE_VADDR_W[2] = '{VADDR_RD_W[PIPE_VPORT_IDX[i]], VADDR_RD_W[PIPE_VPORT_IDX[i]+1]};
            localparam int unsigned PIPE_VPORT_W[1] = '{VPORT_RD_W[PIPE_VPORT_IDX[i]]};
            localparam int unsigned PIPE_VADDR_W[1] = '{VADDR_RD_W[PIPE_VPORT_IDX[i]]};
`endif
